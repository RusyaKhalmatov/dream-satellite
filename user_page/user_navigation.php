                    ...
                    <div class="collapse navbar-collapse" id="resp-menu">
                       ...
                       <form class="navbar-form navbar-right" role="search" >
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="listNav" id="ma"><a href="../main_page/MAIN.php">Main</a></li>
                            <li class="listNav" id="prod"><a href="../scripts/trips_temp.php">Trips</a></li>
                            <li class="listNav" id="adv"><a href="../scripts/adv_temp.php">Advantages</a></li>
                            <li class="listNav" id="news"><a href="../scripts/news_temp.php">News</a></li>
                            <li class="listNav" id="cont"><a href="../scripts/contacts_temp.php">Contacts</a></li>
